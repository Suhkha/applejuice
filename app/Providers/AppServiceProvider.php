...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(Charts $charts)
    {
        ...
        $charts->register([
            ...
            \App\Charts\MuscleQualityCharts::class,
            \App\Charts\BoneMassCharts::class,
            \App\Charts\VisceralCharts::class,
            \App\Charts\IMCCharts::class,
            \App\Charts\WaterCharts::class,
