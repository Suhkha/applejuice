...
class HistoryUserController extends Controller
{
    ...
    public function index()
    {
        ...
        $goals = Goal::where('user_id', $id)->first();
        ...
        return view('panel.history', compact('user', 'goals', 'galleryNow', 'galleryOld', 'weight', 'fat', 'muscle', 'quality', 'bone', 'visceral', 'imc', 'water', 'metabolic', 'waist', 'thigh', 'hips', 'biceps'));  
