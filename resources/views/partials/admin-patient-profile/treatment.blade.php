...
<div class="block w-full overflow-x-auto">
    <div class="card inline-block overflow-hidden">
        <div class="card__copy w-full px-4 max-w-full flex-grow flex-1">
            ...
            <div class="relative w-full max-w-full flex-grow flex-1">
                <a href="{{ route('edit-treatment', ['id' => $treatment->id, 'profile_id' => $userDetail->id]) }}" class="bg-teal-400 text-white text-xs font-bold uppercase px-6 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">Editar tratamiento</a>
            </div>
        </div>
    </div>
</div>