...
<div class="block w-full overflow-x-auto">
    <div class="card inline-block overflow-hidden">
        <div class="card__copy w-full px-0 md:px-4 max-w-full flex-grow flex-1">
            ...
            <div class="relative w-full max-w-full flex-grow flex-1">
                <a href="{{ route('edit-gynecological', ['id' => $gynecological->id, 'profile_id' => $userDetail->id]) }}" class="bg-teal-400 text-white text-xs font-bold uppercase md:px-6 px-3 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"  >Editar antecedentes</a>
            </div>
        </div>
    </div>
</div>