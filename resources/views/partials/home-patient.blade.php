    ...
    <div class="lg:px-20 px-3 pb-20 pt-8">
        <div class="grid grid-cols-1 lg:grid-cols-2">
            <div class="grid grid-cols-1 lg:content-center">
                ...
                <a href="{{ route('history') }}" class="mt-6 p-2 block text-white bg-teal-400 hover:bg-orange-400 ease-linear transition-all duration-150 rounded outline-none focus:outline-none w-fit h-fit">¡Quiero ver!</a>
            </div>
        </div>
    </div>
