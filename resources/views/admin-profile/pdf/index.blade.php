...
@section('content')
    <div class="grid grid-cols-1">
        ...
        <form action="{{ route('pdf.store', $id) }}" method="post" enctype="multipart/form-data" id="pdf-upload" class="dropzone bg-teal-100 px-9 py-9 w-full h-fit text-center border-dotted border-2 border-teal-400">
            @csrf
            <div>
