...
@section('content')
    ...
    <form action="{{ route('medicines.store') }}" class="svelfit-form"   method="POST">
        ...
        <div class='flex items-center justify-start pt-10 mx-7'>
            <input type="button" value="Añadir medicamento" class="bg-blue-400 text-white font-medium hover:bg-blue-300 text-xs uppercase md:px-6 px-3 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 list_add">
        </div>
