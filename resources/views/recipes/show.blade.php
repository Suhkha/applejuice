...
@section('content')
    <div class="w-3/4">
        <div class="card__title text-2xl mb-3 px-4 py-3 border-0 text-white bg-teal-400 flex justify-between">
            ...
            <a href="{{ route('recipes.edit', $recipe->id) }}" class="bg-white text-teal-400 text-xs font-bold uppercase px-6 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">Editar receta</a>
        </div>
