    ...
    <form action="{{ route('anthropometric.update', $anthropometric->id) }}" method="POST" class="svelfit-form"  >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-3 md:mx-7">
            <div class="grid grid-cols-1">
                ...
                <input class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-teal-300" type="date" name="appointment" value="{{ $anthropometric->appointment }}" placeholder="Fecha de nacimiento"  />
            </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-3 md:mx-7">
            <div class="grid grid-cols-1">
        ...
        <div class="grid grid-cols-1 mt-5 mx-3 md:mx-7">
            ...
            <textarea class="styled w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-teal-300" name="comments" placeholder="Comentarios" value="{{ $anthropometric->comments }}">{{ $anthropometric->comments }}</textarea>
        </div>
