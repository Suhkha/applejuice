...
@section('content')
    ...
    <form action="{{ route('category-products.store') }}" method="POST" class="form-serialize" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid grid-cols-1 mt-5 mx-7">
            ...
            <input class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-teal-300" type="file" name="cover" placeholder="Portada" />
        </div>
